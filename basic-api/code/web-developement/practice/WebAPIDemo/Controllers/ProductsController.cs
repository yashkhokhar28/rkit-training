...
namespace WebAPIDemo.Controllers
{
    ...
    public class ProductsController : ApiController
    {
        ...
        {
            return lstProducts; // Returns the list of all products
        }
        #endregion
        ...
        public IHttpActionResult Put(int id, [FromBody] ProductModel productModel)
        {
            ...
            // Ensure the ProductID cannot be changed by the user
            if (productModel.ProductID != id)
            {
                return BadRequest("ProductID cannot be modified."); // Return 400 if ProductID is changed
            }
